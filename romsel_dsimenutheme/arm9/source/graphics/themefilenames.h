...
#define TFN_GRF_ICON_MSX            TFN_UI_DIRECTORY"/grf/icon_msx"
#define TFN_GRF_ICON_MINI           TFN_UI_DIRECTORY"/grf/icon_mini"
#define TFN_GRF_ICON_HB             TFN_UI_DIRECTORY"/grf/icon_hb"
...
#define TFN_PALETTE_ICON_MSX            TFN_UI_DIRECTORY"/palettes/icon_msx.bin"
#define TFN_PALETTE_ICON_MINI           TFN_UI_DIRECTORY"/palettes/icon_mini.bin"
#define TFN_PALETTE_ICON_HB             TFN_UI_DIRECTORY"/palettes/icon_hb.bin"
...
#define TFN_FALLBACK_BG_BOTTOMMOVINGBG       TFN_FALLBACK_UI_DIRECTORY"/background/bottom_moving"
#define TFN_FALLBACK_BG_BOTTOMMOVING_LBG     TFN_FALLBACK_UI_DIRECTORY"/background/bottom_moving_l"
#define TFN_FALLBACK_BG_BOTTOMMOVING_RBG     TFN_FALLBACK_UI_DIRECTORY"/background/bottom_moving_r"

#define TFN_FALLBACK_BG_BOTTOMBG_DS          TFN_FALLBACK_UI_DIRECTORY"/background/bottom_ds"
#define TFN_FALLBACK_BG_BOTTOMBUBBLEBG_DS    TFN_FALLBACK_UI_DIRECTORY"/background/bottom_bubble_ds"

#define TFN_FALLBACK_UI_LSHOULDER            TFN_FALLBACK_UI_DIRECTORY"/ui/Lshoulder"
#define TFN_FALLBACK_UI_LSHOULDER_GREYED     TFN_FALLBACK_UI_DIRECTORY"/ui/Lshoulder_greyed"
#define TFN_FALLBACK_UI_RSHOULDER            TFN_FALLBACK_UI_DIRECTORY"/ui/Rshoulder"
#define TFN_FALLBACK_UI_RSHOULDER_GREYED     TFN_FALLBACK_UI_DIRECTORY"/ui/Rshoulder_greyed"

#define TFN_FALLBACK_BATTERY0                TFN_FALLBACK_UI_DIRECTORY"/battery/battery0"
#define TFN_FALLBACK_BATTERY1                TFN_FALLBACK_UI_DIRECTORY"/battery/battery1"
#define TFN_FALLBACK_BATTERY2                TFN_FALLBACK_UI_DIRECTORY"/battery/battery2"
#define TFN_FALLBACK_BATTERY3                TFN_FALLBACK_UI_DIRECTORY"/battery/battery3"
#define TFN_FALLBACK_BATTERY4                TFN_FALLBACK_UI_DIRECTORY"/battery/battery4"
#define TFN_FALLBACK_BATTERY1_PURPLE         TFN_FALLBACK_UI_DIRECTORY"/battery/battery1purple"
#define TFN_FALLBACK_BATTERY2_PURPLE         TFN_FALLBACK_UI_DIRECTORY"/battery/battery2purple"
#define TFN_FALLBACK_BATTERY3_PURPLE         TFN_FALLBACK_UI_DIRECTORY"/battery/battery3purple"
#define TFN_FALLBACK_BATTERY4_PURPLE         TFN_FALLBACK_UI_DIRECTORY"/battery/battery4purple"
#define TFN_FALLBACK_BATTERY_CHARGE          TFN_FALLBACK_UI_DIRECTORY"/battery/batterycharge"
#define TFN_FALLBACK_BATTERY_CHARGE_BLINK    TFN_FALLBACK_UI_DIRECTORY"/battery/batterychargeblink"
#define TFN_FALLBACK_BATTERY_FULL            TFN_FALLBACK_UI_DIRECTORY"/battery/batteryfull"
#define TFN_FALLBACK_BATTERY_FULLDS          TFN_FALLBACK_UI_DIRECTORY"/battery/batteryfullDS"
#define TFN_FALLBACK_BATTERY_LOW             TFN_FALLBACK_UI_DIRECTORY"/battery/batterylow"

#define TFN_FALLBACK_VOLUME0                 TFN_FALLBACK_UI_DIRECTORY"/volume/volume0"
#define TFN_FALLBACK_VOLUME1                 TFN_FALLBACK_UI_DIRECTORY"/volume/volume1"
#define TFN_FALLBACK_VOLUME2                 TFN_FALLBACK_UI_DIRECTORY"/volume/volume2"
#define TFN_FALLBACK_VOLUME3                 TFN_FALLBACK_UI_DIRECTORY"/volume/volume3"
#define TFN_FALLBACK_VOLUME4                 TFN_FALLBACK_UI_DIRECTORY"/volume/volume4"

#define TFN_FALLBACK_GRF_BIPS                TFN_FALLBACK_UI_DIRECTORY"/grf/bips"
#define TFN_FALLBACK_GRF_BOX                 TFN_FALLBACK_UI_DIRECTORY"/grf/box"
#define TFN_FALLBACK_GRF_BRACE               TFN_FALLBACK_UI_DIRECTORY"/grf/brace"
#define TFN_FALLBACK_GRF_BUBBLE              TFN_FALLBACK_UI_DIRECTORY"/grf/bubble"
#define TFN_FALLBACK_GRF_BUTTON_ARROW        TFN_FALLBACK_UI_DIRECTORY"/grf/button_arrow"
#define TFN_FALLBACK_GRF_CORNERBUTTON        TFN_FALLBACK_UI_DIRECTORY"/grf/cornerbutton"
#define TFN_FALLBACK_GRF_DIALOGBOX           TFN_FALLBACK_UI_DIRECTORY"/grf/dialogbox"
#define TFN_FALLBACK_GRF_FOLDER              TFN_FALLBACK_UI_DIRECTORY"/grf/folder"
#define TFN_FALLBACK_GRF_ICON_GB             TFN_FALLBACK_UI_DIRECTORY"/grf/icon_gb"
#define TFN_FALLBACK_GRF_ICON_GBA            TFN_FALLBACK_UI_DIRECTORY"/grf/icon_gba"
#define TFN_FALLBACK_GRF_ICON_GBAMODE        TFN_FALLBACK_UI_DIRECTORY"/grf/icon_gbamode"
#define TFN_FALLBACK_GRF_ICON_GG             TFN_FALLBACK_UI_DIRECTORY"/grf/icon_gg"
#define TFN_FALLBACK_GRF_ICON_MD             TFN_FALLBACK_UI_DIRECTORY"/grf/icon_md"
#define TFN_FALLBACK_GRF_ICON_NES            TFN_FALLBACK_UI_DIRECTORY"/grf/icon_nes"
#define TFN_FALLBACK_GRF_ICON_SETTINGS       TFN_FALLBACK_UI_DIRECTORY"/grf/icon_settings"
#define TFN_FALLBACK_GRF_ICON_MANUAL         TFN_FALLBACK_UI_DIRECTORY"/grf/icon_manual"
#define TFN_FALLBACK_GRF_ICON_SG             TFN_FALLBACK_UI_DIRECTORY"/grf/icon_sg"
#define TFN_FALLBACK_GRF_ICON_SMS            TFN_FALLBACK_UI_DIRECTORY"/grf/icon_sms"
#define TFN_FALLBACK_GRF_ICON_SNES           TFN_FALLBACK_UI_DIRECTORY"/grf/icon_snes"
#define TFN_FALLBACK_GRF_ICON_PLG            TFN_FALLBACK_UI_DIRECTORY"/grf/icon_plg"
#define TFN_FALLBACK_GRF_ICON_A26            TFN_FALLBACK_UI_DIRECTORY"/grf/icon_a26"
#define TFN_FALLBACK_GRF_ICON_COL            TFN_FALLBACK_UI_DIRECTORY"/grf/icon_col"
#define TFN_FALLBACK_GRF_ICON_M5             TFN_FALLBACK_UI_DIRECTORY"/grf/icon_m5"
#define TFN_FALLBACK_GRF_ICON_INT            TFN_FALLBACK_UI_DIRECTORY"/grf/icon_int"
#define TFN_FALLBACK_GRF_ICON_PCE            TFN_FALLBACK_UI_DIRECTORY"/grf/icon_pce"
#define TFN_FALLBACK_GRF_ICON_WS             TFN_FALLBACK_UI_DIRECTORY"/grf/icon_ws"
#define TFN_FALLBACK_GRF_ICON_NGP            TFN_FALLBACK_UI_DIRECTORY"/grf/icon_ngp"
#define TFN_FALLBACK_GRF_ICON_CPC            TFN_FALLBACK_UI_DIRECTORY"/grf/icon_cpc"
#define TFN_FALLBACK_GRF_ICON_VID            TFN_FALLBACK_UI_DIRECTORY"/grf/icon_vid"
#define TFN_FALLBACK_GRF_ICON_IMG            TFN_FALLBACK_UI_DIRECTORY"/grf/icon_img"
#define TFN_FALLBACK_GRF_ICON_MSX            TFN_FALLBACK_UI_DIRECTORY"/grf/icon_msx"
#define TFN_FALLBACK_GRF_ICON_MINI           TFN_FALLBACK_UI_DIRECTORY"/grf/icon_mini"
#define TFN_FALLBACK_GRF_ICON_HB             TFN_FALLBACK_UI_DIRECTORY"/grf/icon_hb"
#define TFN_FALLBACK_GRF_ICON_UNK            TFN_FALLBACK_UI_DIRECTORY"/grf/icon_unk"
#define TFN_FALLBACK_GRF_LAUNCH_DOT          TFN_FALLBACK_UI_DIRECTORY"/grf/launch_dot"
#define TFN_FALLBACK_GRF_MOVING_ARROW        TFN_FALLBACK_UI_DIRECTORY"/grf/moving_arrow"
#define TFN_FALLBACK_GRF_PROGRESS            TFN_FALLBACK_UI_DIRECTORY"/grf/progress"
#define TFN_FALLBACK_GRF_SCROLL_WINDOW       TFN_FALLBACK_UI_DIRECTORY"/grf/scroll_window"
#define TFN_FALLBACK_GRF_SMALL_CART          TFN_FALLBACK_UI_DIRECTORY"/grf/small_cart"
#define TFN_FALLBACK_GRF_START_BORDER        TFN_FALLBACK_UI_DIRECTORY"/grf/start_border"
#define TFN_FALLBACK_GRF_START_TEXT          TFN_FALLBACK_UI_DIRECTORY"/grf/start_text"
#define TFN_FALLBACK_GRF_WIRELESSICONS       TFN_FALLBACK_UI_DIRECTORY"/grf/wirelessicons"

#define TFN_FALLBACK_RVID_CUBES              TFN_FALLBACK_UI_DIRECTORY"/video/3dsRotatingCubes.rvid"

#define TFN_FALLBACK_GRF_BOX_FULL            TFN_FALLBACK_UI_DIRECTORY"/grf/box_full"
#define TFN_FALLBACK_GRF_BOX_EMPTY           TFN_FALLBACK_UI_DIRECTORY"/grf/box_empty"
#define TFN_FALLBACK_GRF_CURSOR              TFN_FALLBACK_UI_DIRECTORY"/grf/cursor"
